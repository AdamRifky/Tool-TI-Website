...
<body style="background-color: #f2f2f2;">
    ...
    <section>
        <div class="container p-5">
            <div class="row">
                <div class="col-2" style="background-color: #dce0e6;">
                    <p class="fs-3 fw-bold" style="text-align: center;">Kategori</p>
                    <p class="fs-6">Semua Produk</p>
                    <p class="fs-6">PlayStation</p>
                    <p class="fs-6">Xbox</p>
                    <p class="fs-6">Nintendo</p>
                </div>
                <div class="col-10">
                    <p class="fs-3 fw-bold" style="text-align: center;">Produk</p>
